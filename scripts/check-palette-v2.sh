...
#   rive/                generated by publish-transit from the Transit repo;
#                        fix palette drift at that source, not here
#   transitA/            rollback snapshot of rive/; same source, same rule
...
EXCLUDE_RE='^(design/palette-v2/|rive/|transitA/|style\.css$|assets/index-[A-Za-z0-9_-]+\.css$|scripts/)'
